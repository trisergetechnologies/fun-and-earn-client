        ...
        <View style={styles.modalCard}>
          ...
          <ScrollView contentContainerStyle={styles.content}>
            <Text style={styles.section}>
              At DreamMart, owned and operated by <Text style={styles.bold}>AARUSH MP DREAMS (OPC) PRIVATE LIMITED</Text>, your privacy is very important to us.
            ...
            <Text style={styles.section}>
              <Text style={styles.bold}>AARUSH MP DREAMS (OPC) PRIVATE LIMITED</Text> implements industry-standard security measures to protect your personal information.
            ...
            <Text style={styles.section}>
              <Text style={styles.bold}>AARUSH MP DREAMS (OPC) PRIVATE LIMITED</Text> may update this Privacy Policy from time to time
            ...
            <Text style={styles.section}>
              ...
              <Text style={styles.bold}>AARUSH MP DREAMS (OPC) PRIVATE LIMITED</Text><Text>{'\n'}India</Text>
            </Text>
          </ScrollView>
