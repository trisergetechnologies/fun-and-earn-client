...
const PrivacyPolicyModal = ({ visible, onClose }: Props) => {
  ...
  <Text style={styles.section}>
    At <Text style={{ fontWeight: '600' }}>DreamMart</Text>, operated by <Text style={{ fontWeight: '600' }}>AARUSH MP DREAMS (OPC) PRIVATE LIMITED</Text>, your privacy is very important to us. 
  ...
  <Text style={styles.section}>
    ...
    This Privacy Policy is issued by <Text style={{ fontWeight: '600' }}>AARUSH MP DREAMS (OPC) PRIVATE LIMITED</Text>, 
