...
const TermsAndConditionsModal = ({ visible, onClose }: Props) => {
  ...
  <Text style={styles.section}>
    Welcome to <Text style={{ fontWeight: '600' }}>DreamMart</Text>!  
    DreamMart is owned and operated by <Text style={{ fontWeight: '600' }}>AARUSH MP DREAMS (OPC) PRIVATE LIMITED</Text>.  
  ...
  <Text style={styles.section}>
    All logos, content, designs, and software are the intellectual property of <Text style={{ fontWeight: '600' }}>DreamMart</Text>, 
    owned by <Text style={{ fontWeight: '600' }}>AARUSH MP DREAMS (OPC) PRIVATE LIMITED</Text>.  
