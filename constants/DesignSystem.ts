...
/** Shadow presets for iOS (shadow*) and Android (elevation). Premium soft shadows. */
export const shadows = {
  ...
  /** Subtle, soft shadow for cards and surfaces */
  sm: {
    shadowColor: '#000',
  ...
  /** Default card elevation - soft, premium feel */
  md: {
    shadowColor: '#000',
  ...
  /** Extra soft – for hover/press feedback */
  soft: {
    shadowColor: '#000',
    shadowOffset: { width: 0, height: 2 },
    shadowOpacity: 0.06,
